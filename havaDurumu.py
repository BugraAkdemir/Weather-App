...
api_key = "d519398acd499f820970d7bee1ace305"
url_icon = "https://openweathermap.org/img/wn/{}@2x.png"
...
def main():
    ...
    if weather:
        ...
        icon = ImageTk.PhotoImage(Image.open(requests.get(url_icon.format(weather[3]), stream=True).raw))
